...
# Select all where class == relax
# calculate average for all columns, normal distribution (histogram)
feature = data.loc[data['class'] == 'relax']
feature = feature.loc[:,'tempo':]
